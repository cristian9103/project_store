...
class PedidosTestCase(BaseTestCase):
    ...
    def test_enviar_pedido_no_preparacion_lanza_error(self):
        self.crear_detalle()
    ...
    def test_entregar_pedido_enviado_cambia_estado_a_entregado(self):
        self.crear_detalle()
        ...
        resultado = entregar_pedido(self.pedido)
    ...
    def test_cancelar_pedido_entregado_lanza_error(self):
        self.pedido.estado = EstadoPedido.ENTREGADO
        self.pedido.save(update_fields=["estado"])
    ...
    def test_cancelar_pedido_cancelado_lanza_error(self):
        self.pedido.estado = EstadoPedido.CANCELADO
        self.pedido.save(update_fields=["estado"])
